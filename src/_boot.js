...
// Damascus UI: allow the renderer to load node-pty (used by the cmatrix panel).
// Electron 12 blocks non-context-aware native modules in the renderer unless this is off.
